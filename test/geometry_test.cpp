...
TEST(GeometryModuleTest, IsRectangleTest1) {
    using namespace std;
    string fileName = GeometryModuleTest::getFullPath("is_rectangle_test_1.txt");
...
TEST(GeometryModuleTest, IsRectangleTest2) {
    using namespace std;
    string fileName = GeometryModuleTest::getFullPath("is_rectangle_test_2.txt");
    matrix_int *fourPointsPtr = importIntMatrix(fileName.c_str());
    ASSERT_TRUE(isRectangle(*fourPointsPtr));
}
...
TEST(GeometryModuleTest, IsRectangleTest3) {
    using namespace std;
    string fileName = GeometryModuleTest::getFullPath("is_rectangle_test_3.txt");
    matrix_int *fourPointsPtr = importIntMatrix(fileName.c_str());
    ASSERT_TRUE(isRectangle(*fourPointsPtr));
}
...
TEST(GeometryModuleTest, CountTrianglesTest1) {
    using namespace std;
    string fileName = GeometryModuleTest::getFullPath("count_triangle_test_1.txt");
...
TEST(GeometryModuleTest, CountTrianglesTest2) {
    using namespace std;
    string fileName = GeometryModuleTest::getFullPath("count_triangle_test_2.txt");
    matrix_int *coordinates = importIntMatrix(fileName.c_str());
...
TEST(GeometryModuleTest, CountTrianglesTest3) {
    using namespace std;
    string fileName = GeometryModuleTest::getFullPath("count_triangle_test_3.txt");
    matrix_int *coordinates = importIntMatrix(fileName.c_str());
    ASSERT_EQ(countTriangles(coordinates->arr[0], coordinates->arr[1]), 0);
}